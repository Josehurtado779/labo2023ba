...
source("~/labo2023ba/src/WORKFLOW-ARRECHOYMAS/641_TS_training_strategy_006.r")

# ultimos pasos, muy lentos
source("~/labo2023ba/src/WORKFLOW-ARRECHOYMAS/651_HT_lightgbm_006.r")
source("~/labo2023ba/src/WORKFLOW5ARRECHOYMAS/661_ZZ_final_006.r")
