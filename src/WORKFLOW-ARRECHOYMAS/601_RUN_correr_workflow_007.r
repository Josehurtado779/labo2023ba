...
#source("~/labo2023ba/src/WORKFLOW-ARRECHOYMAS/641_TS_training_strategy_007.r")

# ultimos pasos, muy lentos
#source("~/labo2023ba/src/WORKFLOW-ARRECHOYMAS/651_HT_lightgbm_007.r")
source("~/labo2023ba/src/WORKFLOW5ARRECHOYMAS/661_ZZ_final_007.r")