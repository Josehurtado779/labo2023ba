...
PARAM <- list()
PARAM$experimento <- "ZZ6610_ARRECHO_011"
PARAM$exp_input <- "HT6545_ARRECHO_011"
...
PARAM$semillas <- c(503317, 505601, 507007, 509417, 510529, 102191, 200177, 410551, 552581, 892237)
