...
PARAM <- list()
PARAM$experimento <- "HT6545_ARRECHO_004"

PARAM$exp_input <- "TS6410_ARRECHO_004"

# En caso que se haga cross validation, se usa esta cantidad de folds
PARAM$lgb_crossvalidation_folds <- 5

PARAM$lgb_semilla <- 503317 # cambiar por su propia semilla
...
PARAM$lgb_basicos <- list(
  ...
  lambda_l1 = 700.0, # lambda_l1 >= 0.0
  lambda_l2 = 200.0, # lambda_l2 >= 0.0
...
PARAM$bo_iteraciones <- 62 # iteraciones de la Optimizacion Bayesiana
