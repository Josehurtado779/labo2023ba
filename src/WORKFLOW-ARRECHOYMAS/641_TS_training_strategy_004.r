...
PARAM <- list()
PARAM$experimento <- "TS6410_ARRECHO_004"

PARAM$exp_input <- "FE6310_ARRECHO_004"
...
PARAM$train$undersampling <- 0.16

PARAM$train$semilla <- 503317 # cambiar por su propia semilla  !!!
